...
//stack memory for the functions 
uint32_t stack1[200];
uint32_t stack20[200];
uint32_t stack3[200];

//control blocks for the functions
struct tcb a1,a2,a3;
...
{
	os_init();
	stack_free_list = 0b11100000;
	stack_base[0] = &stack1[199];
	stack_base[1] = &stack3[99];
	stack_base[2] =	&stack20[199];
	
	struct tcb *temp1=&a1; //pointers to thr 
  struct tcb *temp2=&a2;
	struct tcb *temp3=&a3;
